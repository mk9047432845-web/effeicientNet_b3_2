...
async function sendChat(manualMsg = null) {
    ...
    chatBox.innerHTML += `<div class="chat-msg bot-msg"><b>AI:</b> ${data.reply}</div>`;
    
    // ADD THIS: If the bot gives the refusal message, force-load suggestions
    if (data.reply.includes("Try suggested options")) {
        loadSuggestions(); 
    }
